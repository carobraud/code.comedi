 ...
 for(i=0;i<npoint;++i)
   {
	 ...
	 float output_volt1=sin(2*pi*FREQ*input);

	 float output_volt2=sin(2*pi*FREQ*input+pi);
	 
	 int output1=(output_volt1+10)*65535/20; 
	 int output2=(output_volt2+10)*65535/20; 

	 comedi_data_write(device,1/*subdevice*/,0/*channel*/,0/*range*/,0/*aref*/,output1/*data*/);
	 comedi_data_write(device,1/*subdevice*/,1/*channel*/,0/*range*/,0/*aref*/,output2/*data*/);
