...
#define PR(value) fprintf(stderr,#value);fprintf(stderr,"=%d\n",value)
#define PRf(value) fprintf(stderr,#value);fprintf(stderr,"=%lf\n",value)
#define PRs(value) fprintf(stderr,#value);fprintf(stderr,"=%s\n",value)

  void print(struct parsed_options option)
    {
      PRs(option.filename);
      PRf(option.value);
      PR(option.subdevice);
