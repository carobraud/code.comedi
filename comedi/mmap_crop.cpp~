...
int channel_number=cmd->scan_end_arg;
int sample_number=cmd->stop_arg;
cimg_library::CImg<sampl_t> data(channel_number,sample_number*2,1,1);//,sizeof(sampl_t));
data.print("data");
	front = 0;
	back = 0;
int n=0;
